    ...
    <PublicLayout>
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 px-6 py-12 sm:px-10 sm:py-16 lg:px-16 lg:py-20 mb-12 text-white shadow-2xl shadow-blue-600/20">
        ...
        <div className="relative max-w-2xl animate-fade-up">
          ...
          <p className="text-blue-100 text-base sm:text-lg mb-8 max-w-xl leading-relaxed">
            Daftarkan diri dalam berbagai event kampus, dapatkan QR code kehadiran, dan raih sertifikat otomatis — semua dalam satu platform.
          </p>
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-14">
        {[
          ...
          return (
            ...
            >
              <div className={`w-10 h-10 sm:w-11 sm:h-11 mb-3 rounded-xl ${c.bg} flex items-center justify-center ${c.text}`}>
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">{stat.icon}</svg>
              </div>
              <h3 className="text-xl sm:text-2xl font-extrabold text-slate-800">{stat.value}</h3>
      ...
      <section id="events" className="mb-16 scroll-mt-20">
        <div className="flex items-end justify-between mb-7 gap-4">
          <div>
            <span className="inline-block text-xs font-bold text-blue-600 uppercase tracking-wider mb-2">Agenda</span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-800">Event Mendatang</h2>
            <p className="text-slate-500 mt-1.5 text-sm sm:text-base">Jangan lewatkan berbagai event menarik kampus</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl p-12 sm:p-16 text-center border border-slate-200">
            ...
            <h3 className="text-lg font-bold text-slate-700 mb-1.5">Belum Ada Event</h3>
            <p className="text-slate-500 text-sm">Event baru akan segera hadir, pantau terus!</p>
          </div>
        ) : (
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {events.map((event, index) => (
              ...
              >
                ...
                <div className="relative h-44 sm:h-48 overflow-hidden">
                  {event.banner ? (
                    <img
                      src={`http://127.0.0.1:8000/storage/${event.banner}`}
                      alt={event.title}
                  ...
                  <div className="absolute top-3 right-3">
                    <span className="text-xs bg-blue-600 text-white px-2.5 py-1 rounded-full font-semibold shadow-md shadow-blue-600/30">
                      {event.quota === 0 ? "Tanpa Batas" : `${event.quota} Kuota`}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-5">
                  ...
                  <p className="text-slate-500 text-sm mb-4 line-clamp-2 leading-relaxed">
                    {event.description || "Event menarik yang wajib Anda ikuti."}
                  </p>
      ...
      <section id="how-it-works" className="mb-16 scroll-mt-20">
        <div className="text-center mb-10">
          <span className="inline-block text-xs font-bold text-blue-600 uppercase tracking-wider mb-2">Proses</span>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-800 mb-2">Cara Kerja</h2>
          <p className="text-slate-500 text-sm sm:text-base">Mengikuti event kampus kini lebih mudah dalam 3 langkah</p>
        </div>
        <div className="grid md:grid-cols-3 gap-5 sm:gap-6 relative">
          ...
          {[
            { num: "01", title: "Pilih Event", desc: "Jelajahi berbagai event kampus menarik yang tersedia.", color: "blue" },
            { num: "02", title: "Daftar & Dapat QR", desc: "Isi data diri dan dapatkan QR code absensi otomatis.", color: "green" },
            { num: "03", title: "Hadir & Sertifikat", desc: "Scan QR saat hadir, sertifikat dikirim otomatis via email.", color: "amber" },
          ].map((step, index) => {
            ...
            return (
              ...
              >
                <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${ringMap[step.color]} flex items-center justify-center text-white font-extrabold text-lg shadow-lg mb-4 mx-auto md:mx-0`}>
                  {step.num}
                </div>
      ...
      <section id="features" className="mb-16 scroll-mt-20">
        <div className="text-center mb-10">
          <span className="inline-block text-xs font-bold text-blue-600 uppercase tracking-wider mb-2">Keunggulan</span>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-800 mb-2">Mengapa CampusEvent?</h2>
          <p className="text-slate-500 text-sm sm:text-base">Solusi modern untuk pengelolaan event kampus</p>
        </div>
          ...
          {[
            ...
            return (
              <div
                ...
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div className={`w-14 h-14 mb-4 rounded-2xl ${c.bg} flex items-center justify-center ${c.text}`}>
      ...
      <section className="relative overflow-hidden rounded-3xl bg-slate-900 px-6 py-12 sm:px-10 sm:py-14 text-center text-white shadow-xl">
        ...
        <div className="relative">
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-3">Siap Mengikuti Event?</h2>
          <p className="text-slate-300 mb-6 max-w-xl mx-auto text-sm sm:text-base">
            Jelajahi daftar event kampus dan daftarkan diri Anda sekarang. Gratis dan mudah!
          </p>
          <a
            href="#events"
