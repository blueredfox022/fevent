    ...
    return (
      <PublicLayout>
        <div className="py-20 text-center">
          ...
          <p className="mb-2 font-semibold text-slate-600">Data registrasi tidak ditemukan.</p>
          <p className="mb-6 text-sm text-slate-500">
            Halaman ini hanya dapat diakses setelah proses registrasi berhasil.
          </p>
          <Link to="/" className="font-medium text-blue-600 hover:underline">Kembali ke Beranda</Link>
        </div>
      </PublicLayout>
    );
  }
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white text-center shadow-sm">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-green-500 to-green-600 p-8 text-white">
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-sm text-green-100">QR Code berhasil dibuat</p>
            </div>
          </div>
          ...
          <div className="p-5 sm:p-6">
            ...
            <div className="mb-6 space-y-3 text-left">
              <div className="flex items-center justify-between rounded-xl bg-slate-50 p-3 gap-3">
                ...
                <span className="font-semibold text-slate-800 truncate text-right">{participant.name}</span>
              </div>
              <div className="flex items-center justify-between rounded-xl bg-slate-50 p-3 gap-3">
                <span className="text-xs text-slate-500 shrink-0">NIM</span>
                <span className="font-semibold text-slate-800">{participant.nim}</span>
              </div>
              <div className="flex items-center justify-between rounded-xl bg-slate-50 p-3 gap-3">
                <span className="text-xs text-slate-500 shrink-0">Email</span>
                <span className="font-semibold text-slate-800 truncate text-right text-sm">{participant.email}</span>
              </div>
            </div>
            ...
            <div className="mb-6 flex items-start gap-3 rounded-xl border border-blue-100 bg-blue-50 p-4 text-left text-sm text-blue-700">
              ...
              <span>
                Simpan QR Code ini. QR Code juga telah dikirim ke email Anda dan akan digunakan untuk absensi pada hari pelaksanaan event.
              </span>
            </div>
