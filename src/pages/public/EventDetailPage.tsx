    ...
    return (
      <PublicLayout>
        <div className="text-center py-20">
          ...
          <p className="text-slate-600 font-semibold mb-2">Event tidak ditemukan</p>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
            ...
            <div className="p-5 sm:p-6">
              <h2 className="text-lg font-bold text-slate-800 mb-3">Tentang Event</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
                {event.description || "Event menarik yang wajib Anda ikuti. Daftar sekarang dan dapatkan pengalaman berharga!"}
              </p>

              <h3 className="text-base font-bold text-slate-800 mb-3">Yang Anda Dapatkan</h3>
              <div className="grid sm:grid-cols-3 gap-3 mb-6">
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className="text-sm font-semibold text-slate-700">Sertifikat</span>
                  </div>
                  <p className="text-xs text-slate-500">Dikirim otomatis via email</p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className="text-sm font-semibold text-slate-700">QR Absensi</span>
                  </div>
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className="text-sm font-semibold text-slate-700">Networking</span>
                  </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6 lg:sticky lg:top-20">
            <h3 className="text-base font-bold text-slate-800 mb-4">Informasi Event</h3>
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm font-semibold text-slate-800">{formatDate(event.event_date)}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm font-semibold text-slate-800">{event.quota} Peserta</p>
                </div>
              </div>
            </div>
